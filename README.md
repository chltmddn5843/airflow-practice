...
### 📂 데이터베이스 스키마 설계
---
LEGAL_MASTER (부모 테이블)CASE_ID (PK): 판례/법령 고유 번호TITLE: 사건명 또는 법령명FULL_TEXT: 원문 전체 데이터LEGAL_CHUNKS (자식 테이블)CHUNK_ID (PK): 청크 고유 식별자PARENT_ID (FK): MASTER 테이블 외래키
LEVEL: 계층 구분 (조/항/문)CONTENT: 실제 텍스트 내용
---
...
A: "판례(2006다62492) 및 민법 제543조에 따르면... (중략) ... 위와 같이 명시되어 있습니다."

### 향후 발전 계획
- 법령 간 인용 관계를 그래프 DB(Neo4j)로 시각화[ ] 사용자의 질문 의도 분류 기능 추가